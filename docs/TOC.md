...
- [Public Resource Manifest Review](MANIFEST_REVIEW.md)
...
- [Companion Release Candidate — 2026.08.19.1](RELEASE_CANDIDATE.md)
- [Companion Resource Release Checklist](RELEASE_CHECKLIST.md)
- [Release Notes Automation Guidance](RELEASE_NOTES_AUTOMATION.md)
- [Companion Release Readiness](RELEASE_READINESS.md)
