...
def build_checks(root: Path) -> list[list[str]]:
    ...
    return [
        ...
        [py, "tools/companion_projects_check.py", "--root", str(root)],
        ...
        [py, "tools/doc_accessibility.py", "README.md", "docs", "resources", "schemas", "exercises", "examples", "companion-projects"],
        [py, "tools/markdown_links.py", "README.md", "docs", "resources", "schemas", "exercises", "examples", "companion-projects", "ERRATA.md", "ROADMAP.md", "CHANGELOG.md", "what_changed.md"],
        [py, "tools/gumroad_presence.py", "--root", str(root)],
        [py, "tools/policy_status.py", "--root", str(root), "--output", "docs/POLICY_STATUS.md", "--check"],
        [py, "tools/release_readiness.py", "--root", str(root), "--output", "docs/RELEASE_READINESS.md", "--check"],
    ]
